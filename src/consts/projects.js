...
export const PROJECTS = [
  ...
  },
  {
    ...
    desc: {
      es: 'Monitor de precios full-stack: compara el mismo producto en varias tiendas, guarda su histórico y avisa cuando baja del precio objetivo. Cuentas con Google o email y demo sin registro.',
      en: 'Full-stack price tracker: compares the same product across several stores, keeps its price history and alerts you when it drops below your target. Google or email accounts, plus a no-signup demo.',
      ca: "Monitor de preus full-stack: compara el mateix producte a diverses botigues, desa l'històric i avisa quan baixa del preu objectiu. Comptes amb Google o correu i demo sense registre.",
    },
    tags: [
    ...
    details: {
      ...
      stack: 'Next.js 16 · React 19 · TypeScript · Tailwind CSS 4 · Neon Postgres · Drizzle · Better Auth · Cloudflare Workers',
      status: {
        tone: 'pending',
        es: 'Las grandes tiendas no dejan leer sus precios: el catálogo es real pero su evolución se simula (la web lo indica). Faltan los avisos por email.',
        en: 'Big stores do not allow reading their prices: the catalog is real but its price changes are simulated (the site says so). Email alerts are still to come.',
        ca: "Les grans botigues no deixen llegir els seus preus: el catàleg és real però la seva evolució se simula (la web ho indica). Falten els avisos per correu.",
      },
    },
  },
  {
