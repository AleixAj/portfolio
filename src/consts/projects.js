    ...
    details: {
      ...
      highlights: {
        es: [
          ...
          'Estilos que imitan el chat de 8 juegos (WoW, LoL, Valorant, Minecraft, CS2, Overwatch 2, Fortnite y Rust): su letra, su formato de línea, sus colores y sus detalles, con el tipo de usuario donde cada juego tiene su hueco.',
        ...
        en: [
          ...
          'Styles that mimic the chat of 8 games (WoW, LoL, Valorant, Minecraft, CS2, Overwatch 2, Fortnite and Rust): their font, line format, colors and details, with the user type wherever each game has a spot for it.',
        ...
        ca: [
          ...
          'Estils que imiten el xat de 8 jocs (WoW, LoL, Valorant, Minecraft, CS2, Overwatch 2, Fortnite i Rust): la seva lletra, el format de línia, els colors i els detalls, amb el tipus d\'usuari on cada joc té el seu lloc.',
