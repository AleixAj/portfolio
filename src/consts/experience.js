...
export const EDUCATION = [
  {
    ...
    desc: { es: 'JavaScript, TypeScript, HTML, CSS y React.', en: 'JavaScript, TypeScript, HTML, CSS, and React.' },
  },
  {
    center: 'Fundació esplai',
    title: 'Bootcamp PHP',
    period: { es: 'Jul – Sep 2019', en: 'Jul – Sep 2019' },
    desc: { es: '275h presenciales. PHP y Laravel.', en: '275 in-person hours. PHP and Laravel.' },
  },
  {
    center: 'Fundació esplai',
    title: 'Bootcamp Java',
    period: { es: 'Abr – Jun 2019', en: 'Apr – Jun 2019' },
    desc: { es: '275h presenciales. Java y SQL.', en: '275 in-person hours. Java and SQL.' },
  },
  {
    center: 'INS Baix Camp',
    title: { es: 'CFGS Desarrollo de Aplicaciones Web (DAW)', en: 'Higher Vocational Degree in Web Application Development' },
    period: '2015 – 2018',
    desc: '',
  },
  {
    center: 'INS Domènech i Montaner',
    title: { es: 'ESO y Bachillerato Tecnológico', en: 'Secondary Education and Technological Baccalaureate' },
    period: '2008 – 2014',
    desc: '',
  },
]
