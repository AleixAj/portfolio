...
export default function Skills({ lang }) {
  return (
    <section id="skills" className="min-h-[100dvh] ls:h-auto bg-black/45 flex items-start md:items-center ls:items-start pt-16 ls:pt-20 md:pt-24 2xl:pt-28 pb-5 ls:pb-12 md:pb-10 relative overflow-visible">
      <div className="max-w-6xl 2xl:max-w-7xl 3xl:max-w-[100rem] mx-auto px-4 md:px-8 2xl:px-12 text-white w-full">
        <h2 className="text-2xl md:text-5xl 2xl:text-6xl 3xl:text-7xl font-bold mb-2 md:mb-6 2xl:mb-10">Skills</h2>
        <div className="grid md:grid-cols-[1.15fr_0.85fr_1fr] gap-2 md:gap-5 2xl:gap-8">
          {SKILL_CATEGORIES.map(({ title, skills }, categoryIndex) => (
            <div key={title[lang]} style={{ animationDelay: `${categoryIndex * 90}ms` }} className="reveal-item bg-white/5 border border-white/10 rounded-xl md:rounded-2xl 2xl:rounded-3xl p-2 md:p-5 2xl:p-7">
              <h3 className="text-xs md:text-xl 2xl:text-2xl 3xl:text-3xl font-bold text-cyan-400 mb-1.5 md:mb-4 2xl:mb-6">{title[lang]}</h3>
