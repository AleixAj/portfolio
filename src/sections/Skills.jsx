      ...
      <div className="max-w-5xl mx-auto px-5 md:px-8 text-white w-full">
        ...
        <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-1.5 md:gap-3">
          {SKILLS.map(({ label, Icon, color }) => (
            <div key={label} className="reveal-item bg-white/5 backdrop-blur-sm border border-white/10 hover:border-cyan-400/50 hover:shadow-[0_0_20px_rgba(34,211,238,0.3)] p-2 md:p-6 rounded-lg md:rounded-2xl text-center transition-all flex flex-col items-center gap-1 md:gap-3">
