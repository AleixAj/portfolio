...
export default function Projects({ lang, t }) {
  return (
    <section id="projects" className="min-h-[100dvh] ls:h-auto bg-black/45 flex items-center ls:items-start pt-16 ls:pt-20 md:pt-24 2xl:pt-28 pb-5 ls:pb-12 md:pb-10 relative overflow-visible">
