...
export default function Projects({ lang, t }) {
  return (
    <section id="projects" className="min-h-[100dvh] ls:h-auto bg-black/45 flex items-center ls:items-start pt-16 ls:pt-20 md:pt-24 pb-5 ls:pb-12 md:pb-10 relative overflow-visible">
      <div className="max-w-6xl mx-auto px-5 md:px-8 text-white w-full">
        <h2 className="text-2xl md:text-5xl font-bold mb-2 md:mb-6">{t.title}</h2>
